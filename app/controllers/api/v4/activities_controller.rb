class Api::V4::ActivitiesController < Api::V4::ApiController
  ...
  def index
    ...
    tasks = tasks.includes(:type).includes(:custom_field_values).map do |task|
    ...
    objects = {
        ...
        tags: @horse.stable.tags.includes(:tag_type).as_api_response(:basic)
    }
    (1..limit).each do
